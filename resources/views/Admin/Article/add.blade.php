...
{{--body内容--}}
@section('body')
    <form class="layui-form" action="" id="addForm" enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="radio" name="status" value="0" class="layui-input" title="禁止">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">首页显示</label>
                <div class="layui-input-inline">
                    <input type="radio" name="isHome" value="1" class="layui-input" title="是">
                    <input type="radio" name="isHome" value="0" class="layui-input" title="否" checked>
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">推荐显示</label>
                <div class="layui-input-inline">
                    <input type="radio" name="isRecommend" value="1" class="layui-input" title="是">
                    <input type="radio" name="isRecommend" value="0" class="layui-input" title="否" checked>
                </div>
            </div>
        </div>
        {{--<div class="layui-form-item">--}}
